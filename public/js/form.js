...
var dept = "";
var seq_no = "G001";
var web_pno = "10703A000014";
var NList_Type = "1";
var memo = "贈品：12000堂電腦課程";
var IsMoblie = "N";
var Favorite_Class = "";
...
$(function () {
    $('#sBut').click(function () {
        $('#sBut').hide();
        if ($("select[name='ea'] :selected").val() == "") { alert('請挑選您想參加的場次。'); $('#sBut').show(); return false; }
        ...
        var JSonData = {
            ...
            "memo": (memo + $("select[name='ea'] :selected").text() + "；"),
            "web_pno": web_pno,
    ...
    function s(data) {
        if (data[0].result == "1") {
            ...
            if (IsMoblie == "Y") {
                ...
                document.location.href = data[0].reURL;
            }
